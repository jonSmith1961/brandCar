...
$model->active_from = $model->active_from ? Yii::$app->formatter->asDate($model->active_from, 'dd.MM.yyyy') : '';
...
<div class="news-form">
	...
	<?= $form->field($model, 'active_from')->widget(DatePicker::className(), ['language' => 'ru', 'clientOptions' => ['autoclose' => true, 'format' => 'dd.mm.yyyy']]); ?>

    <?= $form->field($model, 'sort')->textInput() ?>

	<?php
	$nameFieldsFile = News::$fieldsNamesInputFile;

	foreach ($nameFieldsFile as $fieldName) {

		$rowImage = $model->$fieldName;
		$fieldNamePost = 'News['.$fieldName.']';
